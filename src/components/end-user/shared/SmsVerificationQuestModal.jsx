...
import { usePhoneCodeQuestSubmit, usePhoneNumberQuestSubmit } from '@hooks/user/quest'
    ...
    <ModalWrapper gap="24px" isOpen={isOpen} onClose={onClose} handleOnClose={handleOnClose}>
      ...
      {currentView === ENTER_PHONE && (
        <>
          ...
          {phoneError && (
            <ChakraBox layout color="red.300" key="sms-phone-error" exit={{ opacity: 0 }}>
              {phoneError}
            </ChakraBox>
          )}
      ...
      {currentView === VERIFIED && (
        <>
          ...
          <Text w="100%" color="brand.neutral0" align="center" fontSize="md">
            You finished Sms verification. Return to challenges to claim your reward.
          </Text>
