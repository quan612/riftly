...
export const TransparentWalletIcon = () => {
  return (
    <svg width="100%" height="100%" viewBox="0 0 21 18" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M20 3H13C11.4087 3 9.88258 3.63214 8.75736 4.75736C7.63214 5.88258 7 7.4087 7 9C7 10.5913 7.63214 12.1174 8.75736 13.2426C9.88258 14.3679 11.4087 15 13 15H20V17C20 17.2652 19.8946 17.5196 19.7071 17.7071C19.5196 17.8946 19.2652 18 19 18H1C0.734784 18 0.48043 17.8946 0.292893 17.7071C0.105357 17.5196 0 17.2652 0 17V1C0 0.734784 0.105357 0.48043 0.292893 0.292893C0.48043 0.105357 0.734784 0 1 0H19C19.2652 0 19.5196 0.105357 19.7071 0.292893C19.8946 0.48043 20 0.734784 20 1V3ZM13 5H21V13H13C11.9391 13 10.9217 12.5786 10.1716 11.8284C9.42143 11.0783 9 10.0609 9 9C9 7.93913 9.42143 6.92172 10.1716 6.17157C10.9217 5.42143 11.9391 5 13 5ZM13 8V10H16V8H13Z" fill="#2F4E6D" />
    </svg>
